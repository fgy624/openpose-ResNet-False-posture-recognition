...
import sys
sys.path.append('C:/Users/25014/Desktop/vr/vr5.2/yolov5-master')
import os
import time
import sys
import cv2
...
from classfy.ResNet.predict import main
...
class Ui_MainWindow(QWidget):
    ...
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("错误姿势识别系统")
        ...
        self.groupBox_3.setGeometry(QtCore.QRect(1190, 100, 331, 220))
        self.groupBox_3.setStyleSheet("background:#3C3F41;")
        self.groupBox_3.setTitle("")
        self.groupBox_3.setObjectName("groupBox_3")
        self.pushButton_3 = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_3.setGeometry(QtCore.QRect(65, 20, 200, 40))
...
"font:bold;")
        ...
        self.pushButton_pic2.setGeometry(QtCore.QRect(65, 90, 200, 40))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(20)
        font.setBold(True)
...
"font:bold;")
        ...
        self.pushButton_pic2.clicked.connect(self.upload_pic2) 


        self.pushButton_4 = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_4.setGeometry(QtCore.QRect(65, 160, 200, 40))
        font = QtGui.QFont()
        font.setFamily("华文楷体")
        font.setPointSize(20)
        font.setBold(True)
...
"font:bold;")
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(60, 100, 1051, 700))
        self.groupBox_4.setStyleSheet("")
        self.groupBox_4.setTitle("")
        self.groupBox_4.setObjectName("groupBox_4")

        self.label_3 = QtWidgets.QLabel(self.groupBox_4)
        self.label_3.setGeometry(QtCore.QRect(100, 20, 200, 40))
...
"font-size:30px;\n"
        ...
        self.label_3_pic2 = QtWidgets.QLabel(self.groupBox_4)
        self.label_3_pic2.setGeometry(QtCore.QRect(100, 350, 200, 40))
        self.label_3_pic2.setStyleSheet("color:white;\n"
"font-size:30px;\n"
)
        self.label_3_pic2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3_pic2.setObjectName("label_3_pic2")


        self.label_12 = QtWidgets.QLabel(self.groupBox_4)
        self.label_12.setGeometry(QtCore.QRect(750, 20, 200, 40))
...
"font-size:30px;")
        ...
        self.label_12_pic2 = QtWidgets.QLabel(self.groupBox_4)
        self.label_12_pic2.setGeometry(QtCore.QRect(750, 350, 200, 40))
        self.label_12_pic2.setStyleSheet("color:white;\n"
"font-size:30px;")
        self.label_12_pic2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_12_pic2.setObjectName("label_12_pic2")


        self.label_13 = QtWidgets.QLabel(self.groupBox_4)
        self.label_13.setGeometry(QtCore.QRect(100, 60, 200, 250))
        self.label_13.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"border-radius:10px;")
        self.label_13.setText("")
        self.label_13.setObjectName("label_13")

        self.label_13_pic2 = QtWidgets.QLabel(self.groupBox_4)
        self.label_13_pic2.setGeometry(QtCore.QRect(100, 400, 200, 250))
        self.label_13_pic2.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"border-radius:10px;")
        self.label_13_pic2.setText("")
        self.label_13_pic2.setObjectName("label_13_pic2")

#         self.label_14 = QtWidgets.QLabel(self.groupBox_4)
#         self.label_14.setGeometry(QtCore.QRect(390, 40, 150, 201))
#         self.label_14.setStyleSheet("background-color:rgb(255, 255, 255);\n"
# "border-radius:10px;")
#         self.label_14.setText("")
#         self.label_14.setObjectName("label_14")
        self.label_15 = QtWidgets.QLabel(self.groupBox_4)
        self.label_15.setGeometry(QtCore.QRect(750, 60, 200, 250))
        self.label_15.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"border-radius:10px;")
        self.label_15.setText("")
        self.label_15.setObjectName("label_15")

        self.label_15_pic2 = QtWidgets.QLabel(self.groupBox_4)
        self.label_15_pic2.setGeometry(QtCore.QRect(750, 400, 200, 250))
        self.label_15_pic2.setStyleSheet("background-color:rgb(255, 255, 255);\n"
"border-radius:10px;")
        self.label_15_pic2.setText("")
        self.label_15_pic2.setObjectName("label_15_pic2")
...
#         self.lcdNumber_2.setObjectName("lcdNumber_2")
        ...
        self.label_10.setGeometry(QtCore.QRect(300, 20, 600, 61))
        font = QtGui.QFont()
        font.setFamily("华文行楷")
...
"font-size:17px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "错误姿势识别"))
        self.pushButton_3.setText(_translate("MainWindow", "上传对照图片"))

        self.pushButton_pic2.setText(_translate("MainWindow", "上传检测图片"))

        self.pushButton_4.setText(_translate("MainWindow", "姿态正误判断"))
        self.label_3.setText(_translate("MainWindow", "对照图片"))

        self.label_3_pic2.setText(_translate("MainWindow", "测试图片"))

        # self.label_11.setText(_translate("MainWindow", "OutPut Image"))
        self.label_12.setText(_translate("MainWindow", "对照图片姿势"))
        # self.label_17.setText(_translate("MainWindow", "人数统计："))
        self.label_10.setText(_translate("MainWindow", "错误姿势识别"))
    ...
    def upload_pic2(self):##上传图像，并检测图片尺寸，尺寸应小于1000*1000
        ...
        if imgName=='':##关闭文件夹则pass（即文件为空）
            ...
            self.uploadimg_pic2=imgName
            jpg = QtGui.QPixmap(imgName).scaled(self.label_13_pic2.width(), self.label_13_pic2.height())
            self.label_13_pic2.setPixmap(jpg)
            img = self.cv_imread()
            if img.shape[0]>2000 or img.shape[1]>2000:
    ...
    def Terminal_Out(self):
        ...
        self.log = "Personal Vectors\n"##每次执行完还需要初始化终端信息
    def Loadresult(self, classname_1, classname_2):
    ...
    def work(self):##调用Pose函数处理图片并显示在窗口上
        ...
        # jpg = QtGui.QPixmap("result_" + self.uploadimg.split('/')[-1][:-4] + ".png").scaled(self.label_13.width(), self.label_13.height())
        # self.label_14.setPixmap(jpg)
        jpg = QtGui.QPixmap("only_Pose_" + self.uploadimg.split('/')[-1][:-4] + ".png").scaled(self.label_13.width(), self.label_13.height())
        self.label_15.setPixmap(jpg)

        self.processor.Pose(self.uploadimg_pic2)
        pc = self.processor.people_count
        self.log+="Image path: " + self.uploadimg + "\n"
        ...
        self.sinOut4.emit("start")
        # jpg = QtGui.QPixmap("result_" + self.uploadimg_pic2.split('/')[-1][:-4] + ".png").scaled(self.label_13.width(), self.label_13.height())
        # self.label_14.setPixmap(jpg)
        jpg = QtGui.QPixmap("only_Pose_" + self.uploadimg_pic2.split('/')[-1][:-4] + ".png").scaled(self.label_13.width(), self.label_13.height())
        self.label_15_pic2.setPixmap(jpg)


        toc=time.time()
        # print(self.uploadimg)
        input_img_1 = "C:/Users/25014/Desktop/2/" + self.uploadimg.split('/')[-2] + '/' + self.uploadimg.split('/')[-1]
        class_name = main(input_img=input_img_1)

        # cmd = 'python C:/Users/25014/Desktop/vr/vr5.2/yolov5-master/classify/predict.py --source ' + input_img_1 + ' --weights C:/Users/25014/Desktop/vr/vr5.2/yolov5-master/runs/train-cls/exp2/weights/best.pt'
        # os.system(cmd)

        input_img_2 = "C:/Users/25014/Desktop/2/" + self.uploadimg_pic2.split('/')[-2] + '/' + self.uploadimg_pic2.split('/')[-1]
        class_name_2 = main(input_img=input_img_2)
        ...
        self.Loadresult(classname_1=class_name, classname_2=class_name_2)
